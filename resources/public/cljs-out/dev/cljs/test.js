...
var G__11876 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11876,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11876;
}
}));
...
args__4742__auto__.push((arguments[i__4737__auto___11882]));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11878){
...
var line = cljs.core.get.call(null,map__11885__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11885__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11884_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11884_SHARP_));
...
var temp__5720__auto___11887 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11887)){
var message_11888 = temp__5720__auto___11887;
cljs.core.println.call(null,message_11888);
} else {
}
...
var temp__5720__auto___11889 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11889)){
var message_11890 = temp__5720__auto___11889;
cljs.core.println.call(null,message_11890);
} else {
}
...
var output_dir__$1 = (function (){var G__11891 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11891,"/"].join('');
} else {
return G__11891;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11893 = exception.stack;
var G__11893__$1 = (((G__11893 == null))?null:clojure.string.split_lines.call(null,G__11893));
var G__11893__$2 = (((G__11893__$1 == null))?null:cljs.core.get.call(null,G__11893__$1,depth));
if((G__11893__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11893__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11894 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11894,(0),null);
var column = cljs.core.nth.call(null,vec__11894,(1),null);
var vec__11897 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11897,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11897,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11897,(2),null);
...
var m__$1 = (function (){var G__11900 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11900__$1 = (((G__11900 instanceof cljs.core.Keyword))?G__11900.fqn:null);
switch (G__11900__$1) {
case "fail":
...
var G__11904 = (function (){var G__11903 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11903);
} else {
return G__11903;
}
})();
...
return cljs.core.vary_meta.call(null,G__11905,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__11909 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11909,(0),null);
var types = vec__11909;
...
return cljs.core.map.call(null,(function (p__11912){
var vec__11913 = p__11912;
var ns = cljs.core.nth.call(null,vec__11913,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11913,(1),null);
return (function (){
...
var G__11916 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__11917 = cljs.core.seq.call(null,vars__$1);
var chunk__11918 = null;
var count__11919 = (0);
var i__11920 = (0);
while(true){
if((i__11920 < count__11919)){
var v = cljs.core._nth.call(null,chunk__11918,i__11920);
var temp__5720__auto___11922 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11922)){
var t_11923 = temp__5720__auto___11922;
each_fixture_fn.call(null,((function (seq__11917,chunk__11918,count__11919,i__11920,t_11923,temp__5720__auto___11922,v,each_fixture_fn,G__11916,G__11916__$1,env,once_fixtures,each_fixtures,vec__11913,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11923)));
});})(seq__11917,chunk__11918,count__11919,i__11920,t_11923,temp__5720__auto___11922,v,each_fixture_fn,G__11916,G__11916__$1,env,once_fixtures,each_fixtures,vec__11913,ns,vars__$1))
);
} else {
}


var G__11924 = seq__11917;
var G__11925 = chunk__11918;
var G__11926 = count__11919;
var G__11927 = (i__11920 + (1));
seq__11917 = G__11924;
chunk__11918 = G__11925;
count__11919 = G__11926;
i__11920 = G__11927;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11917);
if(temp__5720__auto__){
var seq__11917__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11917__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11917__$1);
var G__11928 = cljs.core.chunk_rest.call(null,seq__11917__$1);
var G__11929 = c__4556__auto__;
var G__11930 = cljs.core.count.call(null,c__4556__auto__);
var G__11931 = (0);
seq__11917 = G__11928;
chunk__11918 = G__11929;
count__11919 = G__11930;
i__11920 = G__11931;
continue;
} else {
var v = cljs.core.first.call(null,seq__11917__$1);
var temp__5720__auto___11932__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11932__$1)){
var t_11933 = temp__5720__auto___11932__$1;
each_fixture_fn.call(null,((function (seq__11917,chunk__11918,count__11919,i__11920,t_11933,temp__5720__auto___11932__$1,v,seq__11917__$1,temp__5720__auto__,each_fixture_fn,G__11916,G__11916__$1,env,once_fixtures,each_fixtures,vec__11913,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11933)));
});})(seq__11917,chunk__11918,count__11919,i__11920,t_11933,temp__5720__auto___11932__$1,v,seq__11917__$1,temp__5720__auto__,each_fixture_fn,G__11916,G__11916__$1,env,once_fixtures,each_fixtures,vec__11913,ns,vars__$1))
);
} else {
}


var G__11934 = cljs.core.next.call(null,seq__11917__$1);
var G__11935 = null;
var G__11936 = (0);
var G__11937 = (0);
seq__11917 = G__11934;
chunk__11918 = G__11935;
count__11919 = G__11936;
i__11920 = G__11937;
continue;
}
} else {
