...
var node = cljs_test_display.core.n.call(null,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null),style_string_11969);
...
var len__4736__auto___11973 = arguments.length;
var i__4737__auto___11974 = (0);
while(true){
if((i__4737__auto___11974 < len__4736__auto___11973)){
args__4742__auto__.push((arguments[i__4737__auto___11974]));

var G__11975 = (i__4737__auto___11974 + (1));
i__4737__auto___11974 = G__11975;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq11970){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11971,G__11972,seq11970__$2);
}));
...
var vec__11976 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__11976,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__11976,(1),null);
var G__11979 = cljs.core.PersistentArrayMap.EMPTY;
var G__11979__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__11979,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11979);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__11979__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__11979__$1;
}
} else {
...
return (function() { 
var G__11983__delegate = function (klass,contents){
var vec__11980 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__11980,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__11980,(1),null);
...
var G__11983 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__11984__i = 0, G__11984__a = new Array(arguments.length -  1);
while (G__11984__i < G__11984__a.length) {G__11984__a[G__11984__i] = arguments[G__11984__i + 1]; ++G__11984__i;}
  contents = new cljs.core.IndexedSeq(G__11984__a,0,null);
} 
return G__11983__delegate.call(this,klass,contents);};
G__11983.cljs$lang$maxFixedArity = 1;
G__11983.cljs$lang$applyTo = (function (arglist__11985){
var klass = cljs.core.first(arglist__11985);
var contents = cljs.core.rest(arglist__11985);
return G__11983__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__11989){
...
var ns = cljs.core.get.call(null,map__11990__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__11990__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__11992){
...
var actual = cljs.core.get.call(null,map__11993__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__11993__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__11995){
...
var expected = cljs.core.get.call(null,map__11996__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__11996__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11998_SHARP_){
return cljs.core.cons.call(null,new_current_node,p1__11998_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__12000 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__12000__$1;
var name = cljs.core.get.call(null,map__12000__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__12000__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__12000__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__11999_SHARP_){
return cljs.core.cons.call(null,node,p1__11999_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__12002){
...
var m = map__12003__$1;
var fail = cljs.core.get.call(null,map__12003__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__12003__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__12003__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__12003__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___12005 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12005)){
var message_12006 = temp__5720__auto___12005;
cljs.core.println.call(null,message_12006);
} else {
}
...
var temp__5720__auto___12007 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12007)){
var message_12008 = temp__5720__auto___12007;
cljs.core.println.call(null,message_12008);
} else {
}
