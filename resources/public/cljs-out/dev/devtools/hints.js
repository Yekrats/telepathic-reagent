...
var map__14291 = top_item;
var map__14291__$1 = (((((!((map__14291 == null))))?(((((map__14291.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14291.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14291):map__14291);
var file = cljs.core.get.call(null,map__14291__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14291__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14291__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e14290){var _e = e14290;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___14293 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___14293)){
var seen_errors_14294 = temp__5718__auto___14293;
if(cljs.core.truth_(seen_errors_14294.has(self))){
} else {
seen_errors_14294.add(self);

var temp__5720__auto___14295 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___14295)){
var sense_14296 = temp__5720__auto___14295;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_14296)].join(''));
} else {
}
}
} else {
