...
var o13166 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13166["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13167 = temp__5718__auto____$1;
return (o13167["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12275__auto__ = f;
return (o__12275__auto__["toString"]).call(o__12275__auto__);
} else {
return "";
}
}catch (e13168){var _ = e13168;
return "";
}});
...
try{var o__12275__auto___13170 = t;
(o__12275__auto___13170["cljs$lang$ctorPrWriter"]).call(o__12275__auto___13170,t,writer);
}catch (e13169){var __13171 = e13169;
}
...
var char_code = (function (){var o__12275__auto__ = (new String(char$));
return (o__12275__auto__["charCodeAt"]).call(o__12275__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12275__auto__ = String;
return (o__12275__auto__["fromCharCode"]).call(o__12275__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13172 = num_code;
switch (G__13172) {
case (1):
return (185);
...
var o__12275__auto__ = String;
return (o__12275__auto__["fromCharCode"]).call(o__12275__auto__,superscript_code);
});
/**
...
}catch (e13174){var _e__12282__auto__ = e13174;
return false;
}})())){
...
var vec__13175 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13175,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o13178 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13178["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13179 = temp__5718__auto____$1;
return (o13179["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13182){
var vec__13183 = p__13182;
var ns_detector = cljs.core.nth.call(null,vec__13183,(0),null);
...
var G__13189 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13190 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13189;
remaining_tokens = G__13190;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13180){
var G__13181 = cljs.core.first.call(null,seq13180);
var seq13180__$1 = cljs.core.next.call(null,seq13180);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13181,seq13180__$1);
}));
...
var vec__13194 = cljs.core.split_with.call(null,(function (p1__13193_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13193_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13194,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13194,(1),null);
...
var vec__13200 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13200,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13200,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13203 = cljs.core.rest.call(null,remaining_tokens);
var G__13204 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13203;
name_tokens = G__13204;
continue;
} else {
...
var vec__13207 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13207,(0),null);
var arity = cljs.core.nth.call(null,vec__13207,(1),null);
var vec__13210 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13210,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13210,(1),null);
var vec__13213 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13213,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13213,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13213,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13213,(3),null);
...
var vec__13219 = result;
var munged_ns = cljs.core.nth.call(null,vec__13219,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13219,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13219,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13219,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13219,(4),null);
var arity = cljs.core.nth.call(null,vec__13219,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13223 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13223,(0),null);
var args = cljs.core.nth.call(null,vec__13223,(1),null);
var vec__13226 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__13229 = (arity + (1));
var G__13230 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13231){
var vec__13232 = p__13231;
var arity = cljs.core.nth.call(null,vec__13232,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13232,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13235_SHARP_){
return cljs.core.get.call(null,arities,p1__13235_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13236_SHARP_){
return cljs.core.drop.call(null,(2),p1__13236_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13239){
var vec__13240 = p__13239;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13240,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13237){
var G__13238 = cljs.core.first.call(null,seq13237);
var seq13237__$1 = cljs.core.next.call(null,seq13237);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13238,seq13237__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13248__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13248__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13248__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13248__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13249 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13249,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13249,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13249,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13249,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13249,(4),null);
var arity = cljs.core.nth.call(null,vec__13249,(5),null);
...
var o__12275__auto__ = f;
return (o__12275__auto__["getBasis"]).call(o__12275__auto__);
});
/**
...
}catch (e13253){var _e__12282__auto__ = e13253;
...
var G__13254 = (obj[cljs.core.first.call(null,path)]);
var G__13255 = cljs.core.rest.call(null,path);
obj = G__13254;
path = G__13255;
continue;
} else {
...
var _STAR_ = (function (accum,p__13256){
var vec__13257 = p__13256;
var bit = cljs.core.nth.call(null,vec__13257,(0),null);
var protocol = cljs.core.nth.call(null,vec__13257,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13260){
var vec__13261 = p__13260;
var ns = cljs.core.nth.call(null,vec__13261,(0),null);
var name = cljs.core.nth.call(null,vec__13261,(1),null);
var selector = cljs.core.nth.call(null,vec__13261,(2),null);
...
var post_process = (function (p__13265){
var vec__13266 = p__13265;
var munged_name = cljs.core.nth.call(null,vec__13266,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13266,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13264_SHARP_){
return (obj[cljs.core.first.call(null,p1__13264_SHARP_)]);
}),sorted_matches);
