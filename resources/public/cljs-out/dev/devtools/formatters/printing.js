...
var len__4736__auto___13300 = arguments.length;
var i__4737__auto___13301 = (0);
while(true){
if((i__4737__auto___13301 < len__4736__auto___13300)){
args__4742__auto__.push((arguments[i__4737__auto___13301]));

var G__13302 = (i__4737__auto___13301 + (1));
i__4737__auto___13301 = G__13302;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13297){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13298,G__13299,seq13297__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13303_SHARP_){
return (!((cljs.core.meta.call(null,p1__13303_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__13304__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13308){var _e__12282__auto__ = e13308;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e13310){var _e__12282__auto__ = e13310;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13312 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13313 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13313);

try{var map__13314 = opts;
...
var markup_db = cljs.core.get.call(null,map__13314__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13312);
}});
...
var temp__5718__auto___13319 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13319)){
var managed_print_level_13320 = temp__5718__auto___13319;
var _STAR_print_level_STAR__orig_val__13317_13321 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13318_13322 = managed_print_level_13320;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13318_13322);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__13316_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13316_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13317_13321);
}} else {
job_fn.call(null);
}
