...
var G__10237 = o;
goog.object.set(G__10237,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10239__i < G__10239__a.length) {G__10239__a[G__10239__i] = arguments[G__10239__i + 0]; ++G__10239__i;}
  args = new cljs.core.IndexedSeq(G__10239__a,0,null);
} 
...
var args = cljs.core.seq(arglist__10240);
...
var G__10241 = o;
goog.object.set(G__10241,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10243__i < G__10243__a.length) {G__10243__a[G__10243__i] = arguments[G__10243__i + 0]; ++G__10243__i;}
  args = new cljs.core.IndexedSeq(G__10243__a,0,null);
} 
...
var G__10245 = props;
var G__10245__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10245,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10245);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10245__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10245__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10246 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10246,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10246;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10247){
var map__10248 = p__10247;
var map__10248__$1 = (((((!((map__10248 == null))))?(((((map__10248.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10248.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10248):map__10248);
var on_write = cljs.core.get.call(null,map__10248__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__10250_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10250_SHARP_);
}));
} else {
return null;
}
...
var vec__10253 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10253,(0),null);
var id = cljs.core.nth.call(null,vec__10253,(1),null);
var className = cljs.core.nth.call(null,vec__10253,(2),null);
...
var temp__5724__auto___10257 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___10257 == null)){
} else {
var key_10258 = temp__5724__auto___10257;
(jsprops.key = key_10258);
}
...
var temp__5724__auto___10259 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___10259 == null)){
} else {
var key_10260 = temp__5724__auto___10259;
(jsprops.key = key_10260);
}
...
var temp__5724__auto___10261 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___10261 == null)){
} else {
var key_10262 = temp__5724__auto___10261;
(jsprops.key = key_10262);
}
...
var G__10264 = n;
if(cljs.core._EQ_.call(null,"",G__10264)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__10264)){
return x;
} else {
...
var len__4736__auto___10267 = arguments.length;
var i__4737__auto___10268 = (0);
while(true){
if((i__4737__auto___10268 < len__4736__auto___10267)){
args__4742__auto__.push((arguments[i__4737__auto___10268]));

var G__10269 = (i__4737__auto___10268 + (1));
i__4737__auto___10268 = G__10269;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10265){
var G__10266 = cljs.core.first.call(null,seq10265);
var seq10265__$1 = cljs.core.next.call(null,seq10265);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10266,seq10265__$1);
}));
...
break;
default:
var G__10272 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10272;
continue;
...
var ctx = ({});
var vec__10274 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__10274,(0),null);
var derefed = cljs.core.nth.call(null,vec__10274,(1),null);
...
var G__10277 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10277) {
case (0):
